...
export default class {
    ...
    async displayRange(context) {
        ...
        .then((rangeUi, js) => {
            Templates.replaceNodeContents(Selectors.filter.regions.valuesByName(this.filterType), rangeUi, js);
            return;
        }).fail();
    }
    ...
    async setUpRangeUi(type, initialValues) {
        ...
        .then((html, js) => {
            Templates.replaceNodeContents(Selectors.filter.regions.rangeByName(this.filterType), html, js);
            this.displayRange(context)
            .then(() => {
