...
class qbank extends base {
    ...
    public function is_uninstall_allowed() {
        $preventuninstall = core_plugin_manager::standard_plugins_list('qbank');
        if (in_array($this->name, $preventuninstall)) {
            // None of the core qbank plugins should be uninstalled.
            return false;
        }
        return true;
    }
