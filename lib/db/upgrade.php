...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2021101500.001) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021101500.001);
    }

    // Next, split question records into the new tables.
    if ($oldversion < 2021101500.002) {
        upgrade_migrate_question_table();

        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021101500.002);
    }

    // Finally, drop fields from question table.
    if ($oldversion < 2021101500.01) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021101500.01);
    }
