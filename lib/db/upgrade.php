...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2021121400.02) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021121400.02);
    }

    if ($oldversion < 2021121400.03) {
        // Next, split question records into the new tables.
        upgrade_migrate_question_table();
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021121400.03);
    }

    // Finally, drop fields from question table.
    if ($oldversion < 2021121400.04) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021121400.04);
    }
