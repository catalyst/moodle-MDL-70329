...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2021101900.02) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021101900.02);
    }

    // Next, split question records into the new tables.
    if ($oldversion < 2021101900.03) {
        upgrade_migrate_question_table();

        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021101900.03);
    }

    // Finally, drop fields from question table.
    if ($oldversion < 2021101900.04) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2021101900.04);
    }
