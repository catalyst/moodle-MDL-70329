...
$string['privacy:metadata:database:question_bank_entry'] = 'The details about a specific question bank entry.';
$string['privacy:metadata:database:question_bank_entry:name'] = 'The name of the question.';
$string['privacy:metadata:database:question_bank_entry:modifiedby'] = 'The person who last updated the question bank entry.';
