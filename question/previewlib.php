...
function question_preview_question_pluginfile($course, $context, $component,
    ...
    qbank_previewquestion\previewquestion_helper::question_preview_question_pluginfile($course, $context,
...
function question_preview_action_url($questionid, $qubaid,
    ...
    qbank_previewquestion\previewquestion_helper::question_preview_action_url($questionid, $qubaid, $options, $context);
}
...
function question_preview_form_url($questionid, $context, $previewid = null) {
    ...
    qbank_previewquestion\previewquestion_helper::question_preview_form_url($questionid, $context, $previewid);
}
...
function restart_preview($previewid, $questionid, $displayoptions, $context) {
    ...
    qbank_previewquestion\previewquestion_helper::restart_preview($previewid, $questionid, $displayoptions, $context);
}
