...
class renderer extends \plugin_renderer_base {
     ...
     *
     * @param float $discriminativeefficiency discriminative efficiency
     * @return string
     */
    public function render_discriminative_efficiency($discriminativeefficiency): string {
     ...
     *
     * @param float $discriminationindex discrimination index
     * @return string
     */
    public function render_discrimination_index($discriminationindex): string {
        $displaydata['discrimination_index'] = helper::format_percentage($discriminationindex, false);
        $displaydata['classes'] = helper::add_css_classes($discriminationindex);
