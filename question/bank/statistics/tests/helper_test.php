...
class helper_test extends \advanced_testcase {
     ...
     */
    public function test_get_quizziess() {
        global $DB;
        $this->resetAfterTest();
        $this->setAdminUser();
        // Create a course.
     ...
     * @return float|int
     */
    private function load_question_facility($quiz, $questionid): ?float {
        return helper::load_question_stats_item($quiz, $questionid, 'facility');
    }
     ...
     * @return float|int
     */
    private function load_question_discriminative_efficiency($quiz, $questionid): ?float {
        return helper::load_question_stats_item($quiz, $questionid, 'discriminativeefficiency');
    }
     ...
     * @return float|int
     */
    private function load_question_discrimination_index($quiz, $questionid): ?float {
        return helper::load_question_stats_item($quiz, $questionid, 'discriminationindex');
    }
     ...
     * @return array
     */
    private function prepare_and_submit_quizzes($quiz1attempts, $quiz2attempts) {
     ...
     */
    public function test_load_question_discrimination_index($quiz1attempts, $expectedquiz1discriminationindex,
                                                            $quiz2attempts, $expectedquiz2discriminationindex,
                                                            $expectedaveragediscriminationindex) {
        $this->resetAfterTest();
