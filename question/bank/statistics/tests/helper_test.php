...
class helper_test extends \advanced_testcase {
    ...
    public function test_get_quzziess() {
        ...
        $this->assertArrayHasKey($quiz2->id, $question2quizzes);

        // Add random question to quiz3
        quiz_add_random_questions($quiz3, 0, $cat->id, 1, false);
        $this->submit_quiz($quiz3, $attempt);
        // Quiz 3 will be in one of these array.
        $question1quizzes = helper::get_quizzes($question1->id);
        $question2quizzes = helper::get_quizzes($question2->id);
        $this->assertArrayHasKey($quiz3->id, $question1quizzes + $question2quizzes);
    }
    ...
    public function test_load_question_discriminative_efficiency_provider() {
        yield 'Discriminative efficiency case 1' => [
            ...
            'Expected average efficiency' => ['50.00%', '41.67%', '41.67%', '75.00%'],
        ];
    }
