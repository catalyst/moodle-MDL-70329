...
Feature: Show statistics in question bank
  ...
  Scenario: View facility index from the base view
  ...
  Scenario: View discrimination index from the base view
    Given user "student1" has attempted "Quiz 2" with responses:
      | slot | response |
      |   1  | False    |
      |   2  | False    |
    ...
    When I am on the "Course 1" course page logged in as admin
    And I navigate to "Question bank > Questions" in current page administration
    And I should see "44.72%" in the "TF1" "table_row"
    And I should see "72.36%" in the "TF2" "table_row"
    And I should see "72.36%" in the "TF3" "table_row"
    And I should see "44.72%" in the "TF4" "table_row"
    And I should see "44.72%" in the ".alert-warning" "css_element"
    And I should see "72.36%" in the ".alert-success" "css_element"

  Scenario: View discriminative efficiency from the base view
    Given user "student1" has attempted "Quiz 2" with responses:
      | slot | response |
      |   1  | False    |
      |   2  | False    |
