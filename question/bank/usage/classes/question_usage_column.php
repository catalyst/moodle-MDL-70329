...
class question_usage_column extends column_base {
    ...
    protected function display_content($question, $rowclasses): void {
        global $PAGE;
        $usagecount = helper::get_question_entry_usage_data($question->questionbankentryid, true);
        $attributes = [];
        if (question_has_capability_on($question, 'view')) {
            ...
            //];
            //$usageurl = new \moodle_url('/question/bank/usage/usage.php', $attributes);
            //echo \html_writer::tag('a', $usagecount, ['href' => $usageurl]);
