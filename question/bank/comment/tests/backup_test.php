...
class qbank_comment_backup_restore_test extends \advanced_testcase {
    ...
    public function test_backup_restore() {
        ...
        $corusecontext = \context_course::instance($this->course->id);
        $args = new stdClass;
        $args->context = $corusecontext;
        ...
        $comment1 = $commentobj1->add('new comment for question 1 _ 1');
        ...
        $DB->record_exists('comments', array('id' => $comment1->id));
        $this->assertFalse($DB->record_exists('comments', array('id' => $comment1->id)));
        $this->assertFalse($DB->record_exists('comments', array('id' => $comment2->id)));
