...
Feature: Use the qbank plugin manager page for bulkmove
  ...
  Scenario: Enable/disable bulk move questions bulk action from the base view
    ...
    Then "#bulkactionsui-container input[name='move']" "css_element" should not be visible
    And I navigate to "Plugins > Question bank plugins > Manage question bank plugins" in site administration
    And I click on "Enable" "link" in the "Bulk move questions" "table_row"
    And I am on the "Test quiz" "quiz activity" page
    And I navigate to "Question bank > Questions" in current page administration
    And I click on "#bulkactionsui-container" "css_element"
    And "#bulkactionsui-container input[name='move']" "css_element" should be visible
