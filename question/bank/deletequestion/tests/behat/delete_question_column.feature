...
Feature: Use the qbank plugin manager page for deletequestion
  ...
  Scenario: Enable/disable delete questions bulk action from the base view
    ...
    And I am on the "Test quiz" "quiz activity" page
    And I navigate to "Question bank > Questions" in current page administration
    And I click on "#bulkactionsui-selector" "css_element"
    Then "#bulkactionsui-container input[name='deleteselected']" "css_element" should not be visible
    And I navigate to "Plugins > Question bank plugins > Manage question bank plugins" in site administration
    And I click on "Enable" "link" in the "Delete question" "table_row"
    And I am on the "Test quiz" "quiz activity" page
    And I navigate to "Question bank > Questions" in current page administration
    And I click on "#bulkactionsui-selector" "css_element"
    And "#bulkactionsui-container input[name='deleteselected']" "css_element" should be visible
  ...
  Scenario: I should not see the deleted questions in the base view
    ...
    And I click on "#bulkactionsui-container input[name='deleteselected']" "css_element"
