...
class view {
    ...
    public function process_actions(): void {
        debugging('Function process_actions() is deprecated, please remove the call,
         the API will implement the bulk actions itself.', DEBUG_DEVELOPER);
    ...
    public function process_actions_needing_ui(): bool {
        debugging('Function process_actions_needing_ui() is deprecated, please remove the call,
         the API will implement the bulk actions itself.', DEBUG_DEVELOPER);
        // Associated code is deleted to make sure any incorrect call doesnt not cause any data loss.
        return false;
    }
