...
class view {
    ...
    protected function display_showtext_checkbox($showquestiontext): void {
        ...
        if (class_exists('qbank_previewquestion\\question_text_row')) {
            if (\core\plugininfo\qbank::check_qbank_status('qbank_viewquestiontext')) {
    ...
    protected function display_question_list($contexts, $pageurl, $categoryandcontext,
        ...
        // This part will be refactored in the bulk actions refactoring.
        echo \html_writer::start_tag('form', array('action' => $pageurl->get_path(), 'method' => 'post'));
