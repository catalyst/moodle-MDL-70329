 ...
 * @see \core_question\local\bank\search\category_condition
 */
class category_condition extends condition {
    ...
    public function __construct($cat, $recurse, $contexts, $baseurl, $course, $maxinfolength = null) {
        debugging('Class category_condition in \core_question\bank\search\category_condition is deprecated, 
        please use \core_question\local\bank\search\category_condition', DEBUG_DEVELOPER);
        $this->cat = $cat;
