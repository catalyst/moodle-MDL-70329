 ...
 * @see \core_question\local\bank\search\tag_condition
 */
class tag_condition extends condition {
    ...
    public function __construct(array $contexts, array $selectedtagids = []) {
        debugging('Class tag_condition in \core_question\bank\search\tag_condition is deprecated, 
        please use \core_question\local\bank\search\tag_condition', DEBUG_DEVELOPER);
        global $DB;
