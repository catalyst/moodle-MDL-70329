 ...
 * @see \core_question\local\bank\search\hidden_condition
 */
class hidden_condition extends condition {
    ...
    public function __construct($hide = true) {
        debugging('Class hidden_condition in \core_question\bank\search\hidden_condition is deprecated, 
        please use \core_question\local\bank\search\hidden_condition', DEBUG_DEVELOPER);
        $this->hide = $hide;
        if ($hide) {
